...
export class PokedexService {
  ...
  getDuplicates(): Pokemon[]{
    ...
    this._http.get<any>("/PokemonCollector/servlet/duplicate").subscribe(Response => {
  ...
  redeemAll(): number[]{
    ...
    this._http.get<any>("/PokemonCollector/servlet/redeemAll").subscribe(Response => {
      //test what we get as response
      console.log(Response);
  ...
  redeemSpecific(pokemonId: number): number[]{
    ...
    this._http.post<any>("/PokemonCollector/servlet/redeem", pokemonId).subscribe(Response => {
      //test what we get as response
      console.log(Response);
      //assign data from response to credits variable
      /*WRITE CODE HERE*/
